 ...
 <!-- ======= Sidebar ======= -->
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link"  href="<?= base_url('/AdminJBM/lightBox'); ?>">
      ...
      <div class="row">
        ...
        <!-- Left side columns -->
            ...
            <!-- Reports -->
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Ligthbox <span>/Components</span></h5>
                    ...
                    <?php if (isset($error)) : ?>
                        ...
                        <form action="<?= base_url('/AdminJBM/updateLightBoxAction'); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="gambarLama" value="<?= $lightbox->gambarLightBox; ?>">
                                <div class="input-group mb-3">
                                    <label class="input-group-text" for="gambarLightBox">Upload</label>
                                    <input type="file" class="form-control" name="gambarLightBox" id="gambarLightBox"> <br>
                                </div>
