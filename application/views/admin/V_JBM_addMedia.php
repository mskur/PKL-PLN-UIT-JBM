              ...
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Media <span>/Now</span></h5>
					...
					<form action="<?= base_url('/AdminJBM/addMediaAction'); ?>" method="post" enctype="multipart/form-data">
              <input type="hidden" name="username" value="<?= $username; ?>" readonly>
              <div class="mb-3">
  					    <label class="form-label" for="judulMedia">Judul Media</label>
  					    <input class="form-control" type="text" name="judulMedia" id="namaMedia" value="<?= set_value('judulMedia'); ?>" required>
              </div>
              <div class="mb-3">
  					    <label class="form-label" for="teksMedia">Text Media</label> 
  					    <textarea class="form-control" type="text" id="summernote" name="teksMedia" id="alamatMedia" value="<?= set_value('teksMedia'); ?>" required></textarea>
              </div>
              <div class="mb-3">
					      <label class="form-label" for="gambarMedia">Gambar Media</label> 
					      <input class="form-control" type="file" name="gambarMedia" id="gambarMedia" required>
              </div>
