              ...
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Media <span>/Now</span></h5>
                    ...
                    <form action="<?php echo site_url('AdminJBM/updateAplikasiAction')?>" method="POST">
                    <input type="hidden" name="idAplikasi" value="<?= $aplikasi->idAplikasi; ?>">
                    <div class="mb-3">
                    <label class="form-label" for="namaAplikasi">Nama Aplikasi</label>
                    <input class="form-control" type="text" name="namaAplikasi" value="<?= $aplikasi->namaAplikasi; ?>" required>
            		</div>
                    <div class="mb-3">
                        <label class="form-label" for="alamatAplikasi">Alamat Aplikasi</label>
                        <input class="form-control" type="text" name="alamatAplikasi" value="<?= $aplikasi->alamatAplikasi; ?>" required>
                    </div>
