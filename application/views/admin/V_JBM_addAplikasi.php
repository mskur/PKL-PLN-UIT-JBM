        ...
        <!-- Left side columns -->
            ...
            <!-- Reports -->
              <div class="card">
                ...
                <div class="card-body">
                <h5 class="card-title">Add <span>/Application</span></h5>

                <?php echo validation_errors(); ?>
        				<form action="<?php echo site_url('AdminJBM/addAplikasiAction')?>" method="POST">
        				    <div class="mb-3">
        				      <label class="form-label">Nama Aplikasi</label>
        				      <input class="form-control" type="text" name="namaAplikasi" value="<?= set_value('namaAplikasi'); ?>" required>
        				 	  </div>
        				 	  <div class="mb-3">	
        				 	    <label class="form-label">Alamat Aplikasi</label>	
        				      <input class="form-control" type="text" name="alamatAplikasi" value="<?= set_value('alamatAplikasi'); ?>" required>
        					 </div>
