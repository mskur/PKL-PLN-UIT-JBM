        ...
        <!-- Left side columns -->
            ...
            <!-- Reports -->
              <div class="card">
                ...
                <div class="card-body">
                <h5 class="card-title">Admin <span>/Person</span></h5>
                
                <?php echo validation_errors(); ?>

				<form action="<?php echo site_url('AdminJBM/addAdminAction')?>" method="POST">
					<div class="mb-3">
				    ...
				    <a class="btn btn-danger mb-3" href="<?= base_url('/AdminJBM/viewAdmin'); ?>">Back</a>
				</form>
            </div><!-- End Reports -->
