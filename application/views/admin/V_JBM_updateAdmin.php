              ...
              <div class="card">
                <div class="card-body">
                  <h5 class="card-title">Media <span>/Now</span></h5>
                    ...
                    <form action="<?= base_url('AdminJBM/updateAdminAction')?>" method="POST">
                    <div class="mb-3">
                        <label class="form-label" for="username">Username</label>
                        <input class="form-control" type="text" name="username" id="username" value="<?= $admin->username; ?>" readonly>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="level" id="level">
                            <option value="admin" <?php if($admin->level == 'admin') echo 'selected'; ?>>Admin</option>
                            <option value="superadmin" <?php if($admin->level == 'superadmin') echo 'selected'; ?>>Super Admin</option>
                        </select>
                    </div>
